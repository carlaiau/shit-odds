...
export function SidebarBody({
  ...
  return (
    <div
      ...
      className={clsx(
        className,
        "flex flex-1 flex-col overflow-y-auto p-2 lg:p-4 lg:[&>[data-slot=section]+[data-slot=section]]:mt-8 [&>[data-slot=section]+[data-slot=section]]:mt-2"
      )}
    />
  );
}
...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  let classes = clsx(
    // Base
    "flex w-full items-center gap-3 rounded-lg px-2 py-1 lg:py-2 text-left text-base/6 font-medium text-zinc-950 sm:py-2 sm:text-sm/5",
