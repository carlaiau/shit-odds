...
const colors = {
  ...
  green:
    "bg-green-500/15 text-green-700 group-data-hover:bg-green-500/25 dark:bg-green-500/30 dark:text-green-400 dark:group-data-hover:bg-green-500/50",
  emerald:
  ...
  punt: "bg-punt-100/15 text-punt-700 group-data-hover:bg-punt-100/25 dark:bg-punt-100/10 dark:text-punt-400 dark:group-data-hover:bg-punt-100/20",
};
